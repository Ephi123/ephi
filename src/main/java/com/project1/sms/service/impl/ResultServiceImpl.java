...
public class ResultServiceImpl implements ResultService {
    ...
    @Override
    @Transactional
    public SemesterResultDto recalculateAndSaveSemesterResult(
            String studentId,
    ...
    private SemesterResultDto buildSemesterResult(
            Student student,
            Integer academicYear,
            Integer semester,
    ...
    private int calculateTotalCreditHours(List<Grade> grades) {
    ...
    private boolean isIncludedInGpa(Grade grade) {
        ...
        return !normalizedGrade.isBlank()
                && !List.of("NG", "IC", "IA", "W").contains(normalizedGrade)
    ...
    private boolean isSameOrBefore(Grade grade, Integer academicYear, Integer semester) {
        ...
        Integer gradeSemester = grade.getOffering().getSemester();
